...
Actualiza TODO: `documentos/checklist.md`, `documentos/roadmap.md`, `AGENTS.md`, y otros archivos que hayan cambiado desde la última sesión.
...
4. Cruza `documentos/checklist.md` ↔ `documentos/roadmap.md`
5. Detecta:
